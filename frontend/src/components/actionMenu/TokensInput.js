...
export default function TokensInput(props) {
    const { defaultTokens, setDefaultTokens, customTokens, setCustomTokens } = props;

    // example token = { name: 'TOKEN_NAME', queryParam: 'EXAMPLE_PARAM', value: '{EXAMPLE_VALUE}', isDefault: true|false }
            ...
            <div className='flex flex-col justify-start items-start w-full'>
                ...
                {customTokens.map((token, index) => (
                    ...
                    >
                        ...
                        <div className='flex justify-center items-center h-full w-full'>
                            <Input name='' defaultValue={token.name}
                                onChange={e => setCustomTokens(customTokens.map((token, _index) => (
                ...
                <div className='flex justify-center items-center mt-4 p-1 w-full hover:bg-gray-200 cursor-pointer'
