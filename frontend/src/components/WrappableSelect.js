...
export default function WrappableSelect(props) {
    const {
        array = [],
        value,
        name = ((element) => element.name),
        matchBy = ((element) => element),
        onChange
    } = props;
    ...
    return (
        <div className='relative max-w-none md:max-w-[160px] p-1 cursor-pointer'
            style={{ border: 'solid 1px grey', borderRadius: '6px' }}
            onClick={e => handleSelectClick()}
        >
            <div className='flex justify-between items-center gap-2'>
                <div className='overflow-hidden text-ellipsis px-2' style={{ whiteSpace: 'nowrap' }}>
            ...
            {selectOpen &&
                <div className='absolute bg-white'
                    style={{ top: '100%', left: 0, border: 'solid 1px grey', borderRadius: '6px', zIndex: 100 }}
                >
