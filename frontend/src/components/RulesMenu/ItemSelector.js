...
export default function ItemSelector(props) {
    const { currItems, setItems, itemsList = [], maxItems = Infinity, defaultText = 'Select an item' } = props;

    // filtering out items that are in currItems.
    // prepending an empty string to front of array
    // for 'Select an item' option
